...
export default function MeetingsGrid() {
  ...
  const columns = [
    ...
    { field: 'mentor_last_name', headerName: 'Mentor Last Name', width: 180 },
    { field: 'mentor_first_name', headerName: 'Mentor First Name', width: 180 },
    { field: 'mentee_last_name', headerName: 'Mentee Last Name', width: 180 },
    { field: 'mentee_first_name', headerName: 'Mentee First Name', width: 180 },
    { field: 'meeting_date', headerName: 'Meeting Date', width: 180 },
    { field: 'meeting_start', headerName: 'Meeting Start', width: 180 },
    { field: 'meeting_end', headerName: 'Meeting End', width: 180 },
  ...
  rows = meetings.map((meeting, index) => {
    return (rows = {
      ...
      meeting_start: moment(meeting?.meeting_start, 'hh:mm:ss').format(
        'h:mm A'
      ),
